...
public class RegisterRequest extends StringRequest {
    ...
    // 서버 URL 설정(php 파일 연동)
    final static private String URL="http://dietapp.dothome.co.kr/Register.php";
    private Map<String,String> map;

    public RegisterRequest(String userID, String userPassword, String userName, int userAge,
                           String userGender, int userHeight, int userWeight, Response.Listener<String> listener){
